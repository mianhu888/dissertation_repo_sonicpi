...
signals:
        ...
        void ericLoggingError(QString msg);
    ...
    private:
        ...
        QString fetch_url_path, sample_path, log_path, sp_user_path, sp_user_tmp_path, ruby_server_path, ruby_path, server_error_log_path, logging_error_log_path, server_output_log_path, gui_log_path, scsynth_log_path, init_script_path, exit_script_path, tmp_file_store, process_log_path, port_discovery_path, qt_app_theme_path, qt_browser_dark_css, qt_browser_light_css, qt_browser_hc_css;
        ...
        QString initJson(QString eventType, QString code, QString compileMsgType = "nan", QString compileMsgData = "nan", QString editType = "nan", QString resourceViewTitle = "nan", QString clipboardContent="nan", QString editContent = "nan");
        QString subjectID;
        QVector<QString>* logJsonVector;
        EricLogWorker* logWorker;
        void requestSubjectID();
        void onetimeUpload(QVector<QString>*);
        void registerRoutineUpload();
        void mySleep(int);
    ...
    public slots:
        ...
        void logged_copy();
        void logged_paste();
        void logged_select_all();
        void logged_delete();
        void panel_context_menu(QPoint);
        void logged_panel_copy();
        void logged_panel_select_all();
