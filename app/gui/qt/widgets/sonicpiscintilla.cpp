...
void SonicPiScintilla::sp_copy(){
  mutex->lock();
  SendScintilla(QsciCommand::SelectionCopy);
  deselect();
  mutex->unlock();
}

void SonicPiScintilla::sp_undo()
{
    mutex->lock();
...
void SonicPiScintilla::sp_select_all()
{
    mutex->lock();
...
void SonicPiScintilla::sp_delete()
{
    mutex->lock();
    SendScintilla(QsciCommand::Delete);
    mutex->unlock();
